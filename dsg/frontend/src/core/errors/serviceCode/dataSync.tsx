...
const PublicErrorCode = {
    PartailImportSucess: 'DataSync.PartailImportSucess',
    ImportErrorPartailFailure: 'DataSync.ImportError.PartailFailure',
    RequestErrorEmpty: 'DataSync.RequestError.Empty',
    RequestErrorFormatIncorrect: 'DataSync.RequestError.FormatIncorrect',
    RequestErrorDataNotExist: 'DataSync.RequestError.DataNotExist',
    RequestErrorDataExist: 'DataSync.RequestError.DataExist',
    AuthenticationError: 'DataSync.AuthenticationError',
    DependencyViolation: 'DataSync.DependencyViolation',
    Duplicated: 'DataSync.Duplicated',
    Empty: 'DataSync.Empty',
    Incorrect: 'DataSync.Incorrect',
    InternalError: 'DataSync.InternalError',
    Insufficient: 'DataSync.Insufficient',
    Invalid: 'DataSync.Invalid',
    InvalidAccountStatus: 'DataSync.InvalidAccountStatus',
    InvalidParameter: 'DataSync.InvalidParameter',
    MissingParameter: 'DataSync.MissingParameter',
    NoPermission: 'DataSync.NoPermission',
    NotFound: 'DataSync.NotFound',
    NotReady: 'DataSync.NotReady',
    OperationConflict: 'DataSync.OperationConflict',
    OperationDenied: 'DataSync.OperationDenied',
    OutOfRange: 'DataSync.OutOfRange',
    QuotaExceed: 'DataSync.QuotaExceed',
    UpgradeError: 'DataSync.UpgradeError',
    InternalErrorUnKnowException: 'DataSync.InternalError.UnKnowException',
    InternalErrorRuntimeException: 'DataSync.InternalError.RuntimeException',
    RequestErrorNoHandlerFoundException:
        'DataSync.RequestError.NoHandlerFoundException',
    RequestErrorHttpRequestMethodNotSupportedException:
        'DataSync.RequestError.HttpRequestMethodNotSupportedException',
    RequestErrorMethodArgumentTypeMismatchException:
        'DataSync.RequestError.MethodArgumentTypeMismatchException',
    CatalogServiceError: 'DataSync.CatalogServiceError',
    DataElementServiceError: 'DataSync.DataElementServiceError',
    RuleServiceError: 'DataSync.RuleServiceError',
    DictServiceError: 'DataSync.DictServiceError',
    ExcelExportError: 'DataSync.ExcelExportError',
    ExcelImportError: 'DataSync.ExcelImportError',
    AnyShareError: 'DataSync.AnyShareError',
    DeadlockError: 'DataSync.DeadlockError',
    DataDuplicated: 'DataSync.DataDuplicated',
    SystemBusy: 'DataSync.SystemBusy',
    DataDuplicatedResourceNameConflicted:
        'DataSync.DataDuplicated.ResourceNameConflicted',
    ResourceNotExisted: 'DataSync.ResourceNotExisted',
    ResourceNotExistedParentResourceNotExisted:
        'DataSync.ResourceNotExisted.ParentResourceNotExisted',
    ResourceNotExistedTargetParentResourceNotExisted:
        'DataSync.ResourceNotExisted.TargetParentResourceNotExisted',
    PartialFailure: 'DataSync.PartialFailure',
    DeleteNotAllowed: 'DataSync.DeleteNotAllowed',
    DeleteFailed: 'DataSync.DeleteFailed',
    DateFormatFailed: 'DataSync.DateFormatFailed',
}
...
export const dataSyncCodeMessage = combineToKV(PublicErrorMap)
