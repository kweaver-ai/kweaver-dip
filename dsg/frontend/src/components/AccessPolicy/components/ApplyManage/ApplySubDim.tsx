...
export const SubDimPrefix = 'subdim'
...
const ApplySubDim = ({
    ...
    useEffect(() => {
        ...
        const curMode =
            curViewId && !curViewId?.startsWith(SubDimPrefix)
                ? SubviewMode.Edit
                : SubviewMode.Create
        // 切换模式
        setMode(curMode)
    ...
    const handleEditSure = async (reason: string) => {
        ...
        try {
            ...
            if (visitorChange) {
                ...
                await createIndicatorAuthRequest({
                    spec,
                })
                showRequestMessage(() => {
            ...
            const spec = {
                ...
                rule: {
                    template: {
                        ...
                        name: subViewParams.name,
                        ...JSON.parse(subViewParams?.detail || '{}'),
                    },
                },
            }
...
export default memo(ApplySubDim)
