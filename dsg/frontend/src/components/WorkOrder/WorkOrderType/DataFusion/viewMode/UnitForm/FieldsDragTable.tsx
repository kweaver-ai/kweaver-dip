...
const FieldsDragTable: React.FC<IFieldsDragTable> = forwardRef(
    (props: any, ref) => {
        ...
        const totalColumns: ColumnsType<any> = [
            ...
            {
                title: __('信息项名称'),
                dataIndex: 'info_item_business_name',
                key: 'info_item_business_name',
                ellipsis: true,
                render: (value, record) =>
                    record?.info_item_business_name ||
                    fieldsData.data.find((a) => a.id === record.id)
        ...
        return (
            <div className={styles.fieldsDragTableWrap}>
                <div className={styles.configRightSubTitleWrap}>
                    ...
                    {/* <span className={styles.crt_desc} hidden={!items}>
                        {formulaItem &&
                            formulaInfo[formulaItem?.type].fieldsTip}
                    </span> */}
                    <SearchInput
                ...
                {fetching ? (
                    ...
                    <DndProvider backend={HTML5Backend}>
                        <Table
                            ...
                            pagination={false}
                            scroll={{
                                y: viewHeight * (viewSize / 100) - scrollHeight,
                            }}
                            locale={{
                                emptyText: <Empty />,
                            }}
