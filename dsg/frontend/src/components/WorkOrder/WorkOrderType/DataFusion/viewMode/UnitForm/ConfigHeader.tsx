...
import { FormulaError, FormulaType, formulaInfo } from '../const'
import Icons from '../Icons'
import { FullScreenOutlined, ShouQiOutlined } from '@/icons'
...
const ConfigHeader: React.FC<IConfigHeader> = ({
    ...
    const { viewMode, viewHeight } = useViewGraphContext()
    ...
    return (
        <div className={styles.configHeaderWrap}>
            ...
            <div className={styles.ch_btnWrap}>
                {formulaItem?.type === 'sql' && !fullScreen && (
                ...
                {formulaItem?.type === 'sql' && fullScreen && (
                    <Tooltip title={__('退出全屏')} placement="bottom">
                        <ShouQiOutlined
                            className={styles.fullScreenIcon}
                            onClick={() => {
                ...
                >
                    <div
                        ...
                        hidden={!editDisabled && viewMode !== 'view'}
                    >
                        <CloseOutlined />
                    </div>
                </Tooltip>
