...
import { formatError, getInvestigationReportAudit } from '@/core'
import dataEmpty from '@/assets/dataEmpty.svg'
import DetailModal from '../Investigation/DetailModal'
import AuditModal from './AuditModal'
import { AuditOptionType, AuditType } from './const'
...
const AuditTable = ({ type }: { type: AuditType }) => {
    ...
    const getDataList = async (params) => {
        try {
            setLoading(true)
            const obj = params
            const res = await getInvestigationReportAudit(obj)
        ...
        },
        {
            ...
            render: (text, record) => (
                <div className={styles.line} title={text}>
                    {AuditOptionType.find((o) => o.value === text)?.label ??
                        '--'}
                </div>
            ),
        },
