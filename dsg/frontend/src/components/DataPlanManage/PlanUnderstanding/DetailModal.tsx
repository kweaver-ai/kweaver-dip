...
import { formatError, getDataComprehensionPlanDetail } from '@/core'
import FileIcon from '@/components/File/FileIcon'
import Return from '../Return'
import { getOptionState, StatusOptions } from './helper'
                    ...
                    <div className={styles.detailContent} ref={container}>
                        ...
                        <div className={styles.infoList} hidden={loading}>
                            ...
                            >
                                ...
                                <Descriptions.Item label={__('计划依据')}>
