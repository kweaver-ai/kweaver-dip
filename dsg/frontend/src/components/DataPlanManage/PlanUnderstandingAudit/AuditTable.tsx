...
import { formatError, getDataComprehensionPlanAudit } from '@/core'
import dataEmpty from '@/assets/dataEmpty.svg'
import DetailModal from '../PlanUnderstanding/DetailModal'
...
const AuditTable = ({ type }: { type: AuditType }) => {
    ...
    const getDataList = async (params) => {
        try {
            setLoading(true)
            const obj = params
            const res = await getDataComprehensionPlanAudit(obj)
