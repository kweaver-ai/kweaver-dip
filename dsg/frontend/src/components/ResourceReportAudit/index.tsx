...
import ReportAuditTable from './ReportAuditTable'
import { AuditType } from './const'

const ResourceReportAudit = () => {
    ...
    const tabItemsData = [
        {
            ...
            title: __('待审核'),
            key: AuditType.Tasks,
            children: <ReportAuditTable type={AuditType.Tasks} />,
        },
        {
            label: __('已审核'),
            title: __('已审核'),
            key: AuditType.Historys,
            children: <ReportAuditTable type={AuditType.Historys} />,
        },
    ]
...
export default ResourceReportAudit
