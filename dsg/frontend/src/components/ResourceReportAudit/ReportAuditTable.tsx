...
import { formatError, getSSZDCatlgAuditRecordList, SortDirection } from '@/core'
...
import { getReportState, getStateItem } from '../ResourceReport/helper'

/** 审核表 */
const ReportAuditTable = ({ type }: { type: AuditType }) => {
