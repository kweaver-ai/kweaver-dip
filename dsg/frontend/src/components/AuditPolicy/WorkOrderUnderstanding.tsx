...
const CurrentPolicyType = PolicyType.WorkOrderUnderstanding
const CurrentBizType = BizType.TaskCenter

/**
 * 数据理解工单申请
 */
function WorkOrderUnderstanding() {
...
export default memo(WorkOrderUnderstanding)
