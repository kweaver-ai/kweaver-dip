...
const DirRevocationTable = forwardRef((props: IDirTable, ref) => {
            ...
            <SearchLayout
                ...
                suffixNode={
                    <SortBtn
                        contentNode={
                            <DropDownFilter
                                menus={[DefaultMenu.revocation]}
                                defaultMenu={DefaultMenu.revocation}
...
export default DirRevocationTable
