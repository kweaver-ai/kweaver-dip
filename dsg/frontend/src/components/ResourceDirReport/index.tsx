...
import DirRecordTable from './DirRecordTable'
import DirReportTable from './DirReportTable'
import DirRevocationTable from './DirRevocationTable'
import DirStartTable from './DirStartTable'
import __ from './locale'
import styles from './styles.module.less'

const ResourceDirReport = () => {
    ...
    const getSyncData = async () => {
        ...
        try {
            setIsSyncing(true)
            const res = await createSSZDSyncTask(SSZDSyncTaskEnum.Catalog)
            if (res) {
                // 数据同步  刷新操作
                switch (activeKey) {
        ...
        <div className={styles['dir-report']}>
            ...
            >
                ...
                <div className={styles['dir-report-right']}>
                    ...
                    {activeKey === ISSZDReportRecordType.Revocation && (
                        <DirRevocationTable
                            ref={revocationRef}
                            key="revocation"
                            treeType={activeTabKey}
...
export default ResourceDirReport
