...
const ThirdLeNodeComponent = (props: any) => {
    ...
    const show = useMemo(() => {
        return (
            ...
            nodeData?.children?.[0].nodeType !== NodeType.FourthLeNode
        )
...
const ThirdLeNode = (callback?: any): string => {
    if (callback) {
        callbackColl = callback
    }
    register({
        shape: NodeType.ThirdLeNode,
        effect: ['data'],
        component: ThirdLeNodeComponent,
    })
    return NodeType.ThirdLeNode
}

export default ThirdLeNode
