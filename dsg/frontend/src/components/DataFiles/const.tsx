...
export const commonTitleList = [
    ...
    { label: '数据Owner', value: '', key: 'owner_name' },
    {
        label: '发布状态',
        value: '',
        key: 'publish_status',
...
export const PublishStatusColors = {
    ...
    [PublishStatus.PUB_AUDITING]: '#1890FF',
    [PublishStatus.CHANGE_AUDITING]: '#1890FF',
    [PublishStatus.CHANGE_REJECT]: '#FF4D4F',
    [PublishStatus.PUB_REJECT]: '#FF4D4F',
}

/**
 * 发布状态背景颜色
 */
export const PublishStatusBgColors = {
    [PublishStatus.PUB_AUDITING]: 'rgb(24,144,255,0.07)',
    [PublishStatus.CHANGE_AUDITING]: 'rgb(24,144,255,0.07)',
    [PublishStatus.CHANGE_REJECT]: 'rgb(255,77,79,0.07)',
    [PublishStatus.PUB_REJECT]: 'rgb(255,77,79,0.07)',
}
...
export const statusFilters = [
    ...
    {
        label: __('发布审核中'),
        value: PublishStatus.PUB_AUDITING,
    },
    {
        label: __('发布审核未通过'),
        value: PublishStatus.PUB_REJECT,
    },
]
...
export const validateNameRepeat = async (value: string): Promise<void> => {
