...
import styles from '@/components/DataEleManage/styles.module.less'
...
import {
    ...
    searchData,
    SortType,
} from '@/components/DataEleManage/const'
...
import Details from '@/components/DataEleManage/Details'
import EditDataEleForm from '@/components/DataEleManage/EditDataEleForm'
import ImportDataEleModal from '@/components/DataEleManage/ImportDataEleModal'
import { MoreOperate } from '@/components/Directory/const'
import EditDirModal from '@/components/Directory/EditDirModal'
import { StdTreeDataOpt } from '@/components/StandardDirTree/const'
        ...
        const oprs = [
            {
                ...
                btnNode: (
                    ...
                    >
                        ...
                        <span className={styles.operateText}>{__('新建')}</span>
                    </Button>
                ),
