...
const BusinessFormSelect = () => {
    ...
    const { formInfo, targetNode, mid, departmentId } = useSelectedDataContext()
    ...
    const versionParams = useMemo(() => {
        ...
        const dragData = getDragData ? getDragData(formInfo?.id) : {}
    ...
    }, [isDraft, selectedVersion, getDragData, formInfo?.id])
