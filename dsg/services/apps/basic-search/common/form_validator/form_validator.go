...
func BindStructAndValid(v interface{}) error {
	...
	if err != nil {
		...
		return genStructError(validatorErrors.Translate(trans))
	}

	return nil
}

func ValidWithSpan(validFunc func(c *gin.Context, v interface{}) (bool, error), c *gin.Context, v interface{}) (bool, error) {
	_, span := ar_trace.Tracer.Start(c.Request.Context(), "input validation")
	defer span.End()
	return validFunc(c, v)
}
