...
//
//import (
//	"devops.KweaverAI.cn/KweaverAIDevOps/AnyFabric/_git/session/adapter/driver/http_client"
//	"devops.KweaverAI.cn/KweaverAIDevOps/AnyFabric/_git/session/common/log"
//	"devops.KweaverAI.cn/KweaverAIDevOps/AnyFabric/_git/session/common/settings"
//	"errors"
//	"fmt"
//	"go.uber.org/zap"
//	"sync"
...
//)
//func (u *usermgntSvc) SetAnonymous(info *http_client.ASharedLinkInfo) (err error) {
//	// 组装 消息体
...
//		log.WithContext(ctx).Error("SetAnonymous  jsoniter.Marshal err", zap.Error(err))
//		return err
//	}
//	err = u.mqClient.Pub(topic, data)
//	if err != nil {
//		//u.log.WithContext(ctx).Errorln(err)
//		log.WithContext(ctx).Error("SetAnonymous  mqClient Pub err", zap.Error(err))
//		return err
//	}
//	return nil
//}
...
//	if err != nil {
//		//u.log.WithContext(ctx).Errorln(err)
//		log.WithContext(ctx).Error("DeleteAnonymous  jsoniter.Marshal err", zap.Error(err))
//		return err
//	}
//	err = u.mqClient.Pub(topic, data)
//	if err != nil {
//		//u.log.WithContext(ctx).Errorln(err)
//		log.WithContext(ctx).Error("DeleteAnonymous  mqClient Pub err", zap.Error(err))
//		return err
//	}
//	return nil
//}*/
