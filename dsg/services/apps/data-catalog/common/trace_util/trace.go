...
type A2R2Func[A1 any, A2 any, R1 any, R2 any] func(context.Context, A1, A2) (R1, R2)

func TraceA2R2[A1 any, A2 any, R1 any, R2 any](ctx context.Context, spanName string, a1 A1, a2 A2, f A2R2Func[A1, A2, R1, R2]) (R1, R2) {
	ctx, span := ar_trace.Tracer.Start(ctx, spanName)
	defer span.End()
